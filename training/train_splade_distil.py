...
)  # Increasing the train batch size generally improves the model performance, but requires more GPU memory
...
word_embedding_model = train_models.MLMTransformer(model_name, max_seq_length=max_seq_length)
