...
def main(args):
    ...
    all_result_path = sorted(root_dir.glob("**/vocab/all_result.csv"))
    ...
    for i, result_path in enumerate(all_result_path):
        ...
        dataset_name = str(result_path).replace(args.root_dir, "").replace("/result/vocab/all_result.csv", "")
    ...
    df_result_all.to_csv("all_vocab_result.csv")

    save_each_ind(df_result_ndcg_all, dataset_names, "all_vocab_result_ndcg.csv")
    save_each_ind(df_result_recall_all, dataset_names, "all_vocab_result_recall.csv")
    save_each_ind(df_result_recap_all, dataset_names, "all_vocab_result_recap.csv")
